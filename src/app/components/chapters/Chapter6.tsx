    ...
    return (
        <>
            ...
            <ol className="list-decimal pr-8 space-y-4">
                ...
                <li className="text-lg leading-9 text-[#5f5349]">شرایط رو سریع ارزیابی کن. اگه فوریه (مثل آتش‌سوزی یا اورژانس پزشکی جدی)، اولویت اول تماس با شماره‌های اضطراری (آتش‌نشانی: ۱۲۵، اورژانس: ۱۱۵) است. بلافاصله بعد از تماس، مدیر رو در جریان بذار.</li>
                <li className="text-lg leading-9 text-[#5f5349]">اگه شرایط جدیه اما فوری نیست، اولویت با اطلاع‌رسانی فوری به مدیر داخلیه.</li>
            </ol>

            <h3 className="text-2xl font-bold text-[#4A3F35] mt-8 mb-4">حرف آخر</h3>
            <p className="text-lg leading-9 text-[#5f5349]">یک بار دیگه، به جمع ما خوش اومدی. این دفترچه، فقط یک راهنما نبود؛ دعوتی بود برای پیوستن به داستان ما. ما خوشحالیم که تو به تیم ما اضافه شدی و بی‌صبرانه منتظریم تا با انرژی و شخصیت منحصربه‌فرد تو، فصل جدیدی از این داستان رو بنویسیم. حالا بیا با هم، بهانه‌ی حال خوب آدم‌ها باشیم.</p>
        </>
    );
};
