      ...
      <nav id="nav-menu">
        {chapters.map((chapter) => (
          <a
            ...
            className={`block py-3 px-5 text-[1.1rem] font-semibold text-[#4A3F35] rounded-l-xl transition-all duration-200 ease-in-out border-r-4 hover:bg-[#EAE0D5] hover:text-[#8B5E3C] my-1 ${
