...
export default function Home() {
    ...
    return (
        <div className="flex flex-col md:flex-row h-screen bg-[#FDF8F0]">
            <Sidebar
                chapters={CHAPTERS}
            ...
            <main ref={mainContentRef} className="flex-1 pt-20 px-6 pb-6 md:p-12 overflow-y-scroll custom-scrollbar">
                <button
                    id="menu-toggle"
                ...
                {/* Add key prop to force re-mount and re-animation */}
                <div
                    key={activeChapter}
